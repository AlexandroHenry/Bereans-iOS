...
//  Bereans
//
//  Created by Seungchul Ha on 2022/12/31.
//

import SwiftUI

enum OldTestament: String, Codable, CaseIterable {
...
enum NewTestament: String, Codable, CaseIterable {
...
var old_testament: [BookName] = [.genesis, .exodus, .leviticus, .numbers, .deuteronomy, .joshua, .judges, .ruth, .samuel1, .samuel2, .kings1, .kings2, .chronicles1, .chronicles2, .ezra, .nehemiah, .esther, .job, .psalms, .proverbs, .ecclesiastes, .songofsongs, .isaiah, .jeremiah, .lamentations, .ezekiel, .daniel, .hosea, .joel, .amos, .obadiah, .jonah, .micah, .nahum, .habakkuk, .zephaniah, .haggai, .zechariah, .malachi]
